...
# ../ffmpeg/ffmpeg -f v4l2 -framerate 25 -video_size 640x480 -i /dev/video$1 -c:v libx264 -c:a libmp3lame -ar 44100 -ac 1 -f flv rtmp://vs43.ailove.ru/webcam/video0 &
...
../ffmpeg/ffmpeg \
    -f x11grab -s 1280x800 -framerate 15  -i :0.0+1280,0 -c:v libx264 \
    -pix_fmt yuv420p \
    -vf "drawtext=fontcolor=black: fontsize=24: \
        ...
        " \
         -an -f flv rtmp://vs43.ailove.ru/webcam/video1
    -vf scale=640:-1 \
